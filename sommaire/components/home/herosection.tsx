        ...
        transition-all animate-in lg:px-12 max-w-7xl">
            ...
            <div className="flex justify-center">
                <div className="relative p-[1px] overflow-hidden
                    ...
                    <Badge
                        variant="secondary"
                        className="relative flex items-center px-6 py-2 text-base
            ...
            <h1 className="font-bold py-6 text-center">
                ...
                <span className="relative inline-block">
                     ...
                     <span className="absolute inset-0 bg-rose-200/50
                    -rotate-2 rounded-lg transform -skew-y-1" aria-hidden="true"></span> 
                </span>{' '}
                summaries
            </h1>
            ...
            <div className="flex justify-center mt-6">
                <Button variant="link" className="text-white text-base sm:text-lg
                    lg:text-xl rounded-full px-8 sm:px-10 lg:px-12 py-6 sm:py-7 lg:py-8
                    lg:mt-16 bg-linear-to-r from-slate-900 to-rose-500
                    hover:from-rose-500 hover:to-rose-900 hover:no-underline 
